...
outputDir = "/Users/polisev/Desktop/TBA/TBAOpt16/CSV_files";
...
for (c = 1; c <= channels; c++) {
    ...
    // Removed - now using line as the roi
...
if (File.exists(csvFileName)) {
    ...
    {
        line = d2s(xValues[i],3) + ", " + d2s(yValuesChannel1[i],3) + ", " + d2s(yValuesChannel2[i],3) + ", " + d2s(yValuesChannel3[i],3);
        print(file, line + "\n");       
   }
